...
def generate_launch_description():
    ...
    rtcm_input_topic_arg = DeclareLaunchArgument(
        ...
        description='Optional RTCM topic remapped into the ublox driver')
    ...
    params = [
        ...
        {'CFG_RATE_MEAS': 10},
        {'CFG_RATE_NAV': 100},
        # GPS1 receives moving-base RTCM on UART2 and can also accept ROS-fed RTCM over USB.
